# Generated by Django 4.1.2 on 2022-10-28 05:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='likes', to='post_feed.post')),
            ],
        ),
        migrations.CreateModel(
            name='Comments',
            fields=[
                ...
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='details', to='post_feed.post')),
            ],
        ),
    ]
